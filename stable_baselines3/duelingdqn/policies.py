...
class DuelingQNetwork(BasePolicy):
    ...
    def __init__(
        ...
        # We set output_dim as 0 for not including final output layers in q_net
        ...
        self.V = nn.Linear(last_layer_dim, 1)
        self.A = nn.Linear(last_layer_dim, action_dim)
    ...
    def forward(self, obs: th.Tensor) -> th.Tensor:
        ...
        flat = self.q_net(self.extract_features(obs)) 
        V = self.V(flat)
        A = self.A(flat)        
...
class DuelingDQNPolicy(BasePolicy):
    """
